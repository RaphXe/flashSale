...
public class RabbitMqConfig {
    ...
    public static final String ORDER_TTL_EXCHANGE = "seckill.order.ttl.exchange";
    public static final String ORDER_TTL_QUEUE = "seckill.order.ttl.queue";
    public static final String ORDER_TTL_ROUTING_KEY = "seckill.order.ttl";

    public static final String ORDER_TIMEOUT_EXCHANGE = "seckill.order.timeout.exchange";
